...
md"""
## Ingest data
First, we need to reload the same data that we used in the first exercise of this lab and perform the same clean up step as last time.
...
md"""# Disaggregating Data"""

# ╔═╡ 2320aba7-aead-422b-b3d1-5f0b0ff01712
md"""
Often it can be useful to **disaggregate** data by one (or more) important characteristics.
For example, we could inspect exoplanets based on their discovery method.
...
md"""
We can access the resulted `GroupedDataFrame`'s using many different notations, e.g. `df_by_method[1]` or `df_by_method[(discoverymethod="Transit",)]`.
...
md"""
**Q1a:** What two methods account for most of the exoplanet discoveries to date?
"""

# ╔═╡ de675406-6d5e-4a8e-b688-fbae99084a91
response_1a = missing

# ╔═╡ 098acca3-8caf-4810-8186-b55c16394058
md"""
...
md"""
**Q1b:** Which discovery method(s) typically result in a measurement of the orbital period?
"""

# ╔═╡ 0e9a2cf0-3114-4a3d-a30d-d72242e9001f
response_1b = missing

# ╔═╡ 5c2a1212-d5cc-47f3-9011-7c78ad062882
md"""
**Q1c:** Which discovery method(s) typically result in a measurement of the planet mass?
"""

# ╔═╡ 92bdc315-a870-48bc-a0cb-d889f9bc0040
response_1c = missing

# ╔═╡ eb2f09c3-540f-4826-bf78-18ad04fb54b0
md"""
**Q1d:** Which discovery method(s) typically result in a measurement of the plant radius?
"""

# ╔═╡ 9356ffbe-08d8-47c9-a0c2-0ecfaf16e16c
response_1d = missing
...
# ╔═╡ 6808a6cc-4f5d-465c-a96d-daa1dad455a4
md"""
**Q1f:** Based on your responses above, propose a strategy for measuring planet densities.
"""

# ╔═╡ 286a4c9e-af96-439b-8c84-11283b2c1869
response_1f = missing

# ╔═╡ de13fa97-677c-40b0-9a7e-a94ddcfdb71f
md"""
# Visualizing disaggregated data
## Histograms of disaggregated data
"""

# ╔═╡ 1469e9e2-9bd5-4a96-84d7-b38847045713
md"""
...
# ╔═╡ 17a52e9b-a88e-4a9b-8f9f-e69d2464dbd5
response_2a = missing

# ╔═╡ 131ebaad-d6b0-4699-be10-308ef5169fea
md"""
**Q2b:**  Describe a potential danger in interpreting the data if one had analyzed only the period distribution lumping all the planets together, rather than disaggregating by discovery type.
"""

# ╔═╡ 8d218afc-72a9-4913-9564-b8856b54cc63
response_2b = missing

# ╔═╡ 9db8be5a-0cfc-4fb8-a242-c6571a7c1d4d
md"""
**Q2c:**  What additional information would we need in order to make an accurate inference about the intrinsic distribution of orbital periods of exoplanets?
"""

# ╔═╡ 01c9cae1-2ebe-46a4-8673-8d458ee2537e
response_2c = missing

# ╔═╡ 5b6a536f-6f1a-47ed-8dfc-d046bf40cd9d
md"""
**Q2d:** Using the code from the figure above as a starting point, make a similar plot comparing the histograms for the eccentricity distribution of planets discovered by the radial velocity and transit methods.
"""
...
md"""
**Q2e:** Make a prediction for what you think is likely responsible for the main differences in the two eccentricity distributions?
"""

# ╔═╡ 09216b95-ff17-41ed-bdca-411f23cf119e
response_2e = missing

# ╔═╡ 721a29dd-7aa7-49b0-9c78-83c6e02c824d
md"""
## Disaggregated 2-D plots
...
# ╔═╡ 119e6bbc-4822-4975-969d-bc339a6fe3b5
response_3a = missing

# ╔═╡ 8833fce9-c021-49bc-8134-982f600f2338
md"## Your turn to explore!"

# ╔═╡ 65ab1750-3d3c-410d-a8f1-20ff98a32e40
md"""
Identify another pair of columns in the database we're using for which you might expect a significant difference in the the distribution depending on the discovery method.  Predict how you think they may different across methods.
"""

# ╔═╡ 28f25045-2949-4bb2-87d3-04393a7b60e1
response_3b = missing

# ╔═╡ 8f987dd0-e23e-4ead-a161-935429bf6f72
md"""
**Q3c:** Drawing from the examples above (or in the previous exercise), make one or two plots that explores the relationship between the two variables you identified.
"""

# ╔═╡ a26c4eaf-b6e7-4b01-b8cc-f67e55a29b7c
tip(md"""
Before you start working on this, check the time.  If you're still working after 20 minutes, then stop, and save the best plot you have to date (even if it's not perfect).  If you're far enough along to respond to Q3e, then please do.  If not, then that's ok, too.
""")
...
md"""
**Q3d:**  Based on your plot(s), reevaluate your prediction for the relationship between the two variables you selected and how they depend on the discovery method.
Explain your improved understanding.
"""
